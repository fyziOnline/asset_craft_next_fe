        ...
        versionSelected.assetVersionBlocks.forEach((item) => {
            if ((item.blockData !== "{}" && item.blockData !== "" && item.blockHTMLGenerated)) {
                htmlContent += (item.ignoreBlock === 0 ? `
                    ...
                    <div style="right:-145px; z-index:20; position:absolute; display:flex; background-color: #f9f9f9; border: 2px dashed #ccc; border-radius: 5px; padding:4px 8px;">
                        <div id="handle-button" data-block-id="${item.assetVersionBlockID}" data-type-div="edit" style=" width:30px; margin-right: 0.5rem; padding-right: 0.5rem; cursor: pointer;">
                        ...
                        <div id="handle-button" data-block-id="${item.assetVersionBlockID}" data-type-div="hidden-block" style="cursor: pointer;" data-ignore-block="${item.ignoreBlock}">
                            <svg clipRule="evenodd" width="46" height="46" fill-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="2" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div style="position:relative;">
                    <div style="right:-88px; top:-5px; z-index:20; position:absolute; display:flex;">
                        <div id="handle-button" style="cursor: pointer; background-color: #f9f9f9; border: 2px dashed #ccc; border-radius: 5px; padding:4px 8px;" data-block-id="${item.assetVersionBlockID}" data-type-div="hidden-block" data-ignore-block="${item.ignoreBlock}">
                            <svg clipRule="evenodd" width="46" height="46" fill-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="2" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                ...
                <div key={idx} >
                    {(item.blockData !== "{}" && item.blockData !== "" && item.ignoreBlock === 0) ? <div className={`flex w-[100%] items-center justify-center absolute ml-[295px] mt-4`} >
                        <div className='flex bg-[#f9f9f9b9] rounded-md border-[2px] border-dashed border-gray-300 border-opacity-70 py-1'>
                            <div className='cursor-pointer pl-2 flex justify-center items-center border-r-2 pr-1'
                                onClick={() => {
                                    setSectionEdit(item)
                                    setIsShowModelEdit(true)
                                }}>
                            ...
                            <div className='cursor-pointer pl-1 pr-2'
                    ...
                    {item.ignoreBlock === 0 ? <ShadowDomContainer htmlContent={item.blockHTMLGenerated || ""}></ShadowDomContainer> :
                        <div>
                            <div className={`flex w-[100%] justify-center absolute ml-[275px] mt-[3px]`} >
                                <div className='bg-[#f9f9f9] rounded-md border-[2.2px] border-dotted border-gray-300' onClick={() => { handleHideBlock(item.assetVersionBlockID, item.ignoreBlock) }}>
                                    <svg clip-rule="evenodd" width="35" height="35" fill-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="2" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
