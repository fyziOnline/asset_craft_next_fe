                    ...
                    <div style="position:relative;">
                        <div style="right: ${assetType === "Landing Page" ? "-70px" : assetType === "LinkedIn" ? "-120px" : "-140px"};  z-index:20; position:absolute; display:flex; align-items:center; gap: 2px; background-color: #f9f9f9; border: 2px dashed #ccc; border-radius: 5px; padding:4px 8px;">
                            <div id="handle-button" data-block-id="${item.assetVersionBlockID}" data-type-div="edit"
                                style="display: flex; align-items: center; justify-content: center; width: 35px; height: 35px; cursor: pointer; border-right: ${assetType === "Landing Page" ? "none" : "2px solid #ccc"}; padding-right: 5px;"
                            ...
                            <div id="handle-button" data-block-id="${item.assetVersionBlockID}" data-type-div="hidden-block"
                                style="display: ${assetType === "Landing Page" ? "none" : "flex"}; align-items: center; justify-content: center; width: 35px; height: 35px; cursor: pointer;"
                                data-ignore-block="${item.ignoreBlock}"
                                onmouseover="this.querySelectorAll('svg path').forEach(p => { p.setAttribute('stroke', '#01a982'); p.setAttribute('fill', '#01a982'); })"
                                onmouseout="this.querySelectorAll('svg path').forEach(p => { p.setAttribute('stroke', 'black'); p.setAttribute('fill', 'black'); })">
