...
const ResizePreviewer: FC<ResizePreviewerProp> = ({ aspectratio, outerBoxWidth, innerBoxWidth, dimensionState }) => {
          ...
          <>
            ...
            <div
              ...
              style={{
                ...
                background: "rgb(80,200,120) linear-gradient(159deg, rgba(80,200,120,1) 0%, rgba(62,180,137,1) 100%)"
              }}
            >
              <div className='absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] text-black'>
                <div className='flex flex-col items-center gap-1 text-[9px] p-1'>
                  <h6 className='text-[10px] text-nowrap'>croped image dimensions</h6>

                  <p className='text-xs text-nowrap'>({dimensionState?.inputWidth} x {dimensionState?.inputHeight})</p>
                </div>
              </div>
            </div>
          </>
