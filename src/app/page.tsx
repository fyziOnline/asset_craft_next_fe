  ...
  return (
    <div>
      <div className="h-full flex flex-col justify-between min-h-[75vh]">
        <div className="flex relative items-center justify-between mr-[15vw] 2xl:pt-[5%]">
          <section className="text-white w-[35rem]">
            <h1 className="text-[60px] leading-[6rem] font-metric font-medium text-green-100 tracking-[1px]">BrandCentral<sup className="text-4xl text-white">ai</sup></h1>
            <p className="text-wrap xl:text-2xl 2xl:text-3xl tracking-wide">Simplifying Marketing Content with AI-Driven</p>
          </section>
