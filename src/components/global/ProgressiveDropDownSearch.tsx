import React, { FC, useState, useEffect, ChangeEvent, KeyboardEvent, useRef, useMemo, useCallback } from 'react'
...
const ProgressiveDropDownSearch: FC<ProgressiveDropDownSearchProps> = ({
  ...
  }, [filteredData, highlightedIndex, handleItemSelect]);
