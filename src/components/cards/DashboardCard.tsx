...
const DashboardCard: React.FC<DashboardCardProps> = ({ projectName, allProjectDate, totalAssets, underReview, inProgress }) => {
  return (
    <div className="group bg-[#F6F6F6] hover:bg-gradient-to-br hover:from-[#00A881] hover:to-[#073634] border border-[#D9D9D9] shadow-sm rounded-[15px] w-[100%] p-4 cursor-pointer hover:border-none">
      ...
      <div className="flex flex-col items-start mt-3">
        ...
        <div className='flex items-baseline gap-4'>
          ...
          <p className="text-base text-[#B0890E] leading-none text-start w-[120px] pl-3 group-hover:text-white">In Progress</p>
        </div>
      </div>
    </div>
  )
